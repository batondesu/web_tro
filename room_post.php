  ...
  <?php } else { ?>
    ...
    <div class="container">
      <div class="main-body">
        ...
        <form id="myForm" class="card" enctype="multipart/form-data" action="room_post_update.php?user_id=<?php echo $user_id ?>"
          method="post">
          ...
          <div class="card-body">
            <div class="row">
              ...
              <div class="col-sm-9 text-secondary">
                <input type="text" name="title" class="form-control" placeholder="Nhập tiêu đề đăng phòng">
              </div>
            </div>
            <hr>
            <div class="row">
              ...
              <div class="col-sm-9 text-secondary">
                <input type="text" name="price" class="form-control" placeholder="Nhập giá phòng(VND)">
              </div>
            </div>
            <hr>
            <div class="row">
              ...
              <div class="col-sm-9 text-secondary">
                <input type="text" name="size" class="form-control" placeholder="Nhập diện tích phòng(m²)">
              </div>
            </div>
            <hr>
            <div class="row">
            ...
            <div class="row">
              ...
              <div class="col-sm-9 text-secondary">
                <input type="text" name="ward" class="form-control" placeholder="Nhập xã, phường">
              </div>
            </div>
            <hr>
            ...
            <div class="row">
              ...
              <div class="col-sm-9 text-secondary">
                <input type="text" name="address" class="form-control" placeholder="Nhập địa chỉ(tên đường, số nhà,...)">
              </div>
            </div>
            <hr>
            ...
            <div class="row">
              ...
              <div class="col-sm-9 text-secondary">
                <input id="imageInput" type="file" name="images[]" accept="image/*" class="form-control"
                  placeholder="Nhập link ảnh phòng trọ (link1,link2,link3,....)" multiple>
              </div>
          ...
          <script>
            document.getElementById('imageInput').addEventListener('change', function (event) {
              ...
              // Lặp qua các tệp tin đã chọn và hiển thị ảnh
              for (const file of event.target.files) {
                ...
                reader.onload = function (e) {
                  ...
                  image.width = 100; // Đặt kích thước ảnh
